...
var playersRef = firebase.database().ref("conference/");
    ...
    $.each(mokData, function (i) {
        var templateString = '<div class="card"><div class="card-head"><img src="./assets/images/6316-removebg-preview.png" width="150px"><h2>'+mokData[i].Conference+'<br><span>'+mokData[i].Type+'</span></h2></div><div class="card-main"><h4><p>Start :'+mokData[i].Start+'</p>End:'+mokData[i].End+'<br>Place:'+mokData[i].Place+'<br></h4></div></div>';
