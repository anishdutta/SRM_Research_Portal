...
var playersRef = firebase.database().ref("PaperPublication/");
    ...
    $.each(mokData, function (i) {
        var templateString = '<div class="card"><div class="card-head"><img src="./assets/images/6316-removebg-preview.png" width="150px"><h2>'+mokData[i].Title+'<br><span>'+mokData[i].PublisherName+'</span></h2></div><div class="card-main"><h4><p>Type :'+mokData[i].Type+'</p>Date:'+mokData[i].Volume+'<br>Subtype:'+mokData[i].Impact+'<br></h4></div></div>';
